	...
	{#each data as item (item.title)}
		<swiper-slide class="h-full w-full">
			<div class="absolute h-full w-full">
				...
				<p
					class="absolute left-[50%] top-[48%] -translate-x-1/2 transform text-center font-roboto text-[2rem] font-medium text-white shadow-black text-shadow md:top-[46%] md:w-[40rem] md:text-[1.8rem] sm:top-[47%] sm:w-[80vw] sm:text-[1.4rem]"
				>
					{item.description}
				</p>
				<button
